...
public enum CameraEngineType {
    case CameraEngine10, CameraEngine9, Other
}

// TODO: 实现工厂
public enum CameraEngineFactory {
    static func factory(for type: CameraEngineType) -> CameraEngineProtocal? {
        switch type {
        case .CameraEngine10:
            //return CameraEngine10()
            break
        case .CameraEngine9:
            //return CameraEngine9()
            break
        default:
            return nil
        }
...
public class CameraEngine: NSObject {
    ...
    var cameraEngineProtocal: CameraEngineProtocal?
    ...
    public static var sharedInstance: CameraEngine {
        get {
    ...
    open class var onceInstance: CameraEngine {
    ...
    public func configureFlash(_ mode: AVCaptureFlashMode) {} //子类重写
    ...
    public func configureInputDevice() {
        do {
            if let currentDevice = self.cameraDevice.currentDevice {
    ...
    public func configureOutputDevice() {} //子类重写


    //MARK: - Extension Device

    public func focus(_ atPoint: CGPoint) -> Bool {
        if let currentDevice = self.cameraDevice.currentDevice {
    ...
    public func capturePhoto(_ blockCompletion: @escaping blockCompletionCapturePhoto) {} //子类重写
    public func capturePhotoBuffer(_ blockCompletion: @escaping blockCompletionCapturePhotoBuffer) {} //子类重写
    public func startRecordingVideo(_ url: URL, blockCompletion: @escaping blockCompletionCaptureVideo) {} //子类重写
    public func stopRecordingVideo() {} //子类重写
...
// TODO: 子类实现
protocol CameraEngineProtocal {
    static func capturePhoto(_ blockCompletion: @escaping blockCompletionCapturePhoto)
